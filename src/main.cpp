...
//
//    //world.add(make_shared<sphere>(point3(0.0, -100.5, -1.0), 100.0, material_ground));
//    auto bunny_test = make_shared<polygon_mesh>(bunny_path, material_metal);
//
...
void scene8(hittable_list& world, camera& cam) {
	...
	make_shared<polygon_mesh>(teapot_path, material_lambertian),
	point3(0, -2, 0),
	vec3(0, 0, 0),
	vec3(0.3, 0.3, 0.3)
    );
	...
	make_shared<polygon_mesh>(teapot_path, material_dielectric),
	point3(-1, -1, 0),
	vec3(0, 0, 0),
	vec3(0.3, 0.3, 0.3)
    );
	...
	make_shared<polygon_mesh>(bunny_path, material_metal2),
	point3(1, -1, 0),
	vec3(0, 0, 0),
	vec3(10, 10, 10)
    );
    ...
    auto moving_sphere = make_shared<transform>(
	make_shared<sphere>(sphere_center1, sphere_center2, 0.2, material_lambertian)
    );
    world.add(moving_sphere);

    auto earth_texture = make_shared<image_texture>("earthmap.jpg");
    auto earth_material = make_shared<lambertian>(earth_texture);
    auto earth_sphere = make_shared<transform>(
	make_shared<sphere>(0.4, earth_material),
	point3(0.6, -0.5, 0.7)
    );
